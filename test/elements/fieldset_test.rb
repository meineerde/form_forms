...
class FieldsetTest < ActionView::TestCase
  test "create a fieldset" do
    ...
    assert_select 'fieldset#payment legend', "These are some fields"
    assert_select 'fieldset#payment input.string#user_credit_card'
  end
  ...
  test "allow nesting of fieldsets" do
    ...
    assert_select 'fieldset#main > div > input.string#user_name'

    assert_select 'fieldset#main > fieldset#payment > legend', "These are some fields"
    assert_select 'fieldset#main > fieldset#payment input.string#user_credit_card'
  end
  ...
  test "dynamically set args and legend" do
    ...
    assert_select 'fieldset#main > legend', 'These are some fields'
    assert_select 'fieldset#block > legend', 'This is a user'
  end
end